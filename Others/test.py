...
#%%
pd.pivot_table(data=data, values="Rate", index="Date", columns=["CCY",'Tenor'])
...
#%%
"""
UPDATE IRS_TS SET Date = '2024-01-25' WHERE Date = '2024-01-26';
...
url = f"https://www.morningstar.com/etfs/xnas/IVAL/portfolio"
r = session.get(url)
print(r.status_code)
print(r)
