...
basics=["SPY","QQQ","EEM","ERUS","EFA","FXI","DBC","GLD","GDX","TLT","DBA","DBB","TUR","GREK","SLV","XLE","XLF","XOP","USO","IYR","EWZ","EWJ","DGS","AAXJ","IHY","HYG","LQD","IEF","PXH","IWN","IWM","^STOXX50E","^N225","^HSCE","FM","VBR"]
assets_coll={  "FX (USD vs XXX)" : FX_list,
                ...
                "Value" : ['EMVL','EEMV','ECOW','DEM','IUSV','VONV','EFV','FYLD','FVAL','SYLD','IVAL','GVAL','QVAL','PRF','VLUE',"IVE",'VTV','VBR','EYLD','PXH'],
                ...
                "Mine" : ["SPY","QQQ","USAI","2828","EEM","EEMV","PXH","EYLD","EFA","ERUS","RSX","FEZ","EZU","TUR","GREK","XLE","XOP","GDX","NGE","PICK","URA","DGS","IEMG","VNM","FM","EXX1","FYLD","WNRG","MLXIX","EMVL"]

                }
reports_colls=["Main Asset Classes","Main Developped","US equities","US sectors","Europe equities","EM equities","Commodity equities","Value"]
...
def ETF_ratios_report():
    ...
    dfRatios=dfRatios.replace(["Select Sector SPDR® Fund","iShares ","MSCI ","SPDR® ","SPDR ","ETF", "Vanguard ","WisdomTree "],"",regex=True)
...
def send_report():
    ...
    send_email(f"Daily quick mkts report - from server", body)
    # send_cyril_andrea(f"Daily quick mkts report", body)
